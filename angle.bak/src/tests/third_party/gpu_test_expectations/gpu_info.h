...
struct GPU_EXPORT GPUInfo {
  ...
  // FGL window system binding vendor.  "" if not available.
  std::string gl_ws_vendor;

  // FGL window system binding version.  "" if not available.
  std::string gl_ws_version;

  // FGL window system binding extensions.  "" if not available.
  std::string gl_ws_extensions;

  // FGL reset notification strategy as defined by GL_ARB_robustness. 0 if GPU
