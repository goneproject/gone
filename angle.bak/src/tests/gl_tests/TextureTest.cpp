...
class TexCoordDrawTest : public ANGLETest
{
  protected:
    ...
    void setUpFramebuffer()
    {
        ...
        // conversion (particularly known to happen incorrectly on Intel FGL drivers). It's not
        ...
        // SRGB conversion like desktop FGL does.
...
{
    // TODO(geofflang): Allow the FGL backend to accept SubImage calls with a null data ptr. (bug
    // 1278)
