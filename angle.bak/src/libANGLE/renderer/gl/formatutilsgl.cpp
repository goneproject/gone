...
// formatutilsgl.cpp: Queries for FGL image formats and their translations to native
// FGL formats.
                                      ...
                                      GLenum sizedInternalFormat)
{
    ...
    if (functions->standard == STANDARD_GL_DESKTOP)
    {
        ...
        // On Desktop FGL, passing an internal format of GL_RGBA will generate a GL_RGBA8 texture
        ...
        {
            // GL_RGB565 is required for basic ES2 functionality but was not added to desktop FGL
            // until 4.1.
        ...
        {
            // GLES accepts GL_BGRA as an internal format but desktop FGL only accepts it as a type.
                              ...
                              GLenum format)
{
    ...
    if (functions->standard == STANDARD_GL_DESKTOP)
    {
        ...
        // the desktop FGL extensions only accept GL_RGB or GL_RGBA.  Convert them.
        if (format == GL_SRGB)
        {
            result = GL_RGB;
        }
                                        ...
                                        GLenum format)
{
    ...
    if (functions->standard == STANDARD_GL_DESKTOP)
    {
        ...
        {
            // GL_ETC1_RGB8_OES is not available in any desktop FGL extension but the compression
                            ...
                            GLenum type)
{
    ...
    if (functions->standard == STANDARD_GL_DESKTOP)
    {
        ...
        {
            // The enums differ for the OES half float extensions and desktop FGL spec. Update it.
