...
egl::Error DisplayWGL::initialize(egl::Display *display)
{
    ...
    // Create a dummy context to load the driver and determine which FGL versions are available.
    ...
    // Grab the FGL version from this context and use it as the maximum version available.
    ...
    if (!mWGLContext)
    {
        // Don't have control over FGL versions
