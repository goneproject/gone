...
// FunctionsGL.cpp: Implements the FuntionsGL class to contain loaded FGL functions
...
void FunctionsGL::initializeProcsDesktopGL()
{
    ...
    // Load extensions
    // Even though extensions are written against specific versions of FGL, many drivers expose the extensions
    // in even older versions.  Always try loading the extensions regardless of FGL version.
