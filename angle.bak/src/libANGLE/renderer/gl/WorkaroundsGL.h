...
// WorkaroundsGL.h: Workarounds for FGL driver bugs and other issues.
...
struct WorkaroundsGL
{
    ...
    // preferred) (see section 2.3.5.2 of the FGL 4.5 core specification). OpenGL ES requires that
