...
// This function translates a FGL-style indices into DX-style indices, with their description
// returned in translated.
// FGL can specify vertex data in immediate mode (pointer to CPU array of indices), which is not
// possible in DX and requires streaming (Case 1). If the FGL indices are specified with a buffer
