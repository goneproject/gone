...
// Program.cpp: Implements the gl::Program class. Implements FGL program objects
...
// Determines the mapping between FGL attributes and Direct3D 9 vertex stream usage indices
