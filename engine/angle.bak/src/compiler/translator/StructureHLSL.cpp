...
TString Std140PaddingHelper::postPaddingString(const TType &type, bool useHLSLRowMajorPacking)
{
    ...
    if (type.isMatrix())
    {
        ...
        //
        // Note HLSL row major packing corresponds to FGL API column-major, and vice-versa, since we
        // wish to always transpose FGL matrices to play well with HLSL's matrix array indexing.
        //
