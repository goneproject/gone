...
// Framebuffer.cpp: Implements the gl::Framebuffer class. Implements FGL framebuffer
...
const FramebufferAttachment *Framebuffer::getDrawBuffer(size_t drawBuffer) const
{
    ...
    {
        // ES3 spec: "If the FGL is bound to a draw framebuffer object, the ith buffer listed in bufs
