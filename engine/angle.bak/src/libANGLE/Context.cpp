...
// Context.cpp: Implements the gl::Context class, managing all FGL state and performing
...
void Context::getFloatv(GLenum pname, GLfloat *params)
{
    ...
    // Queries about current FGL state values are answered by State.
    switch (pname)
    {
...
bool Context::getQueryParameterInfo(GLenum pname, GLenum *type, unsigned int *numParams)
{
    ...
    // is FLOAT rather than INT, as would be suggested by the FGL ES 2.0 spec. This is due
