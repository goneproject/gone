...
{{
    ...
    // which maps FGL formats to DXGI formats.
    if (requireSupport)
    {{
...
// For sized FGL internal formats, there are several possible corresponding D3D11 formats depending
// on device capabilities.
// This function allows querying for the DXGI texture formats to use for textures, SRVs, RTVs and
// DSVs given a FGL internal format.
