...
TEST_P(ImageTest, ValidationGLImage)
{
    ...
    if (eglDisplayExtensionEnabled(window->getDisplay(), "EGL_KHR_gl_texture_2D_image"))
    {
        ...
        // incomplete FGL texture object, and any mipmap levels other than mipmap level 0 are
        ...
        // EGL_GL_TEXTURE_3D_KHR, <buffer> is not the name of a complete FGL texture object, and
        ...
        // EGL_GL_RENDERBUFFER_KHR or EGL_GL_TEXTURE_3D_KHR and <buffer> refers to the default FGL
        // texture object(0) for the corresponding FGL target, the error EGL_BAD_PARAMETER is
        // generated.
        ...
        // EGL_GL_TEXTURE_LEVEL_KHR is not a valid mipmap level for the specified FGL texture object
    ...
    if (eglDisplayExtensionEnabled(window->getDisplay(), "EGL_KHR_gl_texture_cubemap_image"))
    {
        ...
        // not the name of a complete FGL texture object, and one or more faces do not have mipmap
...
TEST_P(ImageTest, ValidationGLEGLImage)
{
    ...
    // If the FGL is unable to create a renderbuffer using the specified eglImageOES, the error
